...
public class BatchConfiguration {
    ...
    public Partitioner partitioner() throws Exception {
        ...
        //System.out.println("file location"+(resolver.getResources("persona*")));
      partitioner.setResources(resolver.getResources("persona*"));
      //  partitioner.setResources(new FileSystemResource[]{new FileSystemResource("out")});
        return partitioner;
  ...
  public FlatFileItemReader<Map<String, String>> reader(@Value("#{stepExecutionContext['fileName']}") String file) throws MalformedURLException {
   //ublic FlatFileItemReader<Map<String, String>> reader(@Value("#{stepExecutionContext['fileName']}") String file) throws MalformedURLException {      // //
        FlatFileItemReader<Map<String, String>> reader = new FlatFileItemReader<>();

        System.out.println("Hi I am in reader");
